...
public:
    HashTableSeperateChaining(std::function<unsigned int(const std::string&, unsigned int)> hash_func) : IHashTable<Type>(hash_func) {table = new DoubleListHT<Bucket<Type>>[16];}
