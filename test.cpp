...
int fill_from_file(IDataStructure<int> *dt, bool direction,int fileIndex)
{
...
int run_all_tests_for_dt(IDataStructure<int>* dt, int to_find, int to_add, int random_position, int data_size, std::string dt_name)
{
    ...
    add_line_to_file(measure_line, (dt_name + "_add_first.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_remove_first.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_add_last.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_remove_last.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_add_random.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_remove_random.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_add_center.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_remove_center.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_find_random.txt"));
    stream.str("");
    ...
    stream << std::fixed << std::setprecision(10) << temp_double_buffor;
    measure_line = std::to_string(data_size) + ";" + stream.str();
    add_line_to_file(measure_line, (dt_name + "_clear.txt"));
    stream.str("");
...
int run_tests()
{
    ...
    int file_number = user_input_action("Podaj ilość plików z katalogu generated_data, które chcesz wczytać: ");
    ...
    for(int i=1; i<=file_number; i++)
    {
        ...
        run_all_tests_for_dt(&list_ht, to_find, to_add, random_position, list_ht.get_size(), "SingleListHeadTail");

        // Run tests for double list
        fill_from_file(&double_list, 0, i);
        ...
        run_all_tests_for_dt(&double_list, to_find, to_add, random_position, double_list.get_size(), "DoubleList");

        // Run tests for dynamic array
        fill_from_file(&dyn_array, 0, i);
        ...
        run_all_tests_for_dt(&dyn_array, to_find, to_add, random_position, dyn_array.get_size(), "DynamicArray");
    }
